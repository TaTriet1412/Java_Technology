...
public class StudentServiceIlm implements StudentService {
    ...
    public List<Student> descendingByAge(){
        return studentRepository.descendingByAge();
    }
    public List<Student> search456PositionStudents(){
        return studentRepository.search456PositionStudents();
    }
}
